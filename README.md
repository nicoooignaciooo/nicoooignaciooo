...
<p align="left"> 
  Soy un estudiante de <strong>Análisis de Programación</strong> apasionado por construir soluciones tecnológicas que resuelvan problemas reales. Actualmente estoy profundizando mis conocimientos en desarrollo web y bases de datos para lanzar mi carrera en el mundo TI.
</p>

- 🔭 Actualmente estoy trabajando en **un proyecto de gestión de tareas con Node.js y Express**.
